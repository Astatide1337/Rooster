/**
 * 🐓 Feed the Rooster - Console Easter Egg Game
 * 
...
const roosterGame = () => {
  ...
  const game = {
    feed: () => {
      ...
      console.clear()
      console.log(`%c🌽 You fed the ${stage.name}!`, styles.success)
      console.log(`%c${stage.art}`, styles.art)

      if (newIdx > oldIdx) {
        console.log(`%c\n🎊 EVOLUTION COMPLETE! Your rooster has grown! 🎊`, styles.title)
      }
      ...
      if (newIdx < stages.length - 1) {
        ...
        console.log(`\n%c👑 MAXIMUM LEVEL REACHED! 👑`, styles.highlight)
      }
    ...
    status: () => {
      ...
      console.clear()
      console.log('%c🐓 ROOSTER STATUS', styles.header)
      console.log(`%c${stage.art}`, styles.art)
    ...
    welcome: () => {
      ...
      console.log(`%cWarning: Highly Addictive 🐔`, styles.secondary)

      console.log('%c\n🎮 COMMANDS:', styles.header)
      console.log(`%crooster.feed()   %c👉 Feed your bird`, styles.button, styles.text)
      console.log(`%crooster.status() %c👉 Check growth`, styles.button, styles.text)
      console.log(`%crooster.fact()   %c👉 Random trivia`, styles.button, styles.text)
      console.log(`%crooster.help()   %c👉 Show this menu`, styles.button, styles.text)
